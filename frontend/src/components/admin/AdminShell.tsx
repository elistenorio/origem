...
const items = [
  { id: "inicio", label: "Início", icon: BiHome, href: "/admin" },
  { id: "gestao", label: "Gestão da plataforma", icon: BiSliderAlt, href: "/admin/gestao" },
  { id: "curadoria", label: "Curadoria", icon: BiBadgeCheck, href: "/admin/curadoria" },
  { id: "acompanhamento", label: "Acompanhamento", icon: BiPulse, href: "/admin/acompanhamento" },
  { id: "indicadores", label: "Indicadores", icon: BiBarChartAlt2, href: "/admin/indicadores" },
  { id: "visao-geral", label: "Visão geral", icon: BiGridAlt, href: "/admin/visao-geral" },
] as const
